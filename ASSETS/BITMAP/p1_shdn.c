...
const unsigned int g_p1_shoot_down_height = 32; /* height in bits */ 
const unsigned int g_p1_shoot_down_width = 32; /* width in bits */
const unsigned int g_p1_shoot_down_size = 128; /* total bytes */

const uint32_t p1_shoot_down[] = {
	0x000fc000,
	0x000fc000,
	0x7ffffffc,
	0x01ffff00,
